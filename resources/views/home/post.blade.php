                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-padding">
                                <p>Interdum et malesuada fames ac ante ipsum primis in faucibus. Fusce eget dolor id
                                    justo luctus commodo vel pharetra nisi. Donec velit libero, gravida vel diam ut,
                                    lobortis mollis quam. Morbi posuere egestas posuere. Curabitur in dui sollicitudin,
                                    lacinia magna at, laoreet sapien. Integer vitae eros nulla.</p>
                                ...
                                <ul class="wall-attrs clearfix list-inline list-unstyled">
                                    ...
                                    <li class="wa-users">
                                        <a href=""><img src="/components/img/profile-pics/1.jpg" alt=""></a>
                                        <a href=""><img src="/components/img/profile-pics/2.jpg" alt=""></a>
                                        <a href=""><img src="/components/img/profile-pics/3.jpg" alt=""></a>
                                        <a href=""><img src="/components/img/profile-pics/5.jpg" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                                ...
                                <div class="wcl-list">
                                    <div class="media">
                                        <a href="" class="pull-left">
                                            <img src="/components/img/profile-pics/5.jpg" alt="" class="lv-img-sm">
                                        </a>
                                        <div class="pull-right p-0">
                                            <ul class="actions">
                                                <li class="dropdown" dropdown="">
                                                    <a href="" dropdown-toggle="" aria-haspopup="true"
                                                        aria-expanded="false">
                                        ...
                                        <div class="media-body">
                                            <a href="" class="a-title">David Nathan</a> <small class="c-gray m-l-10">3
                                                mins ago...</small>
                                            <p class="m-t-5 m-b-0">Maecenas dignissim in neque id commodo. Nam pretium a
                                                tortor a convallis. Curabitur in arcu quis nulla aliquam condimentum.
                                                Morbi eu cursus diam, vitae tristique dui.</p>
                                        </div>
                                    </div>

                                    <div class="media">
                                        <a href="" class="pull-left">
                                            <img src="/components/img/profile-pics/4.jpg" alt="" class="lv-img-sm">
                                        </a>

                                        <div class="media-body">
                                            <a href="" class="a-title">Sam Anderson</a> <small class="c-gray m-l-10">3
                                                mins ago...</small>
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="media">
                                    <div class="pull-left">
                                        <img class="lv-img" src="/components/img/profile-pics/2.jpg" alt="">
                                    </div>
                            ...
                            <div class="card-body card-padding">
                                <p>Donec a ipsum eu tellus auctor sodales. Nulla facilisi. Praesent et ex finibus,
                                    tempor arcu interdum, facilisis mi. Nunc blandit hendrerit nulla, sed rutrum risus.
                                    Nulla eu mollis massa, et laoreet nulla. Ut ut dolor et arcu eleifend elementum ut
                                    eget tellus. Vestibulum eu hendrerit mauris. Suspendisse id tortor vel nisl
                                    tincidunt interdum.</p>

                                <div class="wall-img-preview lightbox clearfix">
                                    <div class="wip-item" data-src="/components/media/gallery/6.jpg"
                                        style="background-image: url(/components/media/gallery/6.jpg);">
                                        <img src="/components/media/gallery/thumbs/6.jpg" alt="">
                                    </div>
                                    <div class="wip-item" data-src="/components/media/gallery/7.jpg"
                                        style="background-image: url(/components/media/gallery/7.jpg);">
                                        <img src="/components/media/gallery/thumbs/7.jpg" alt="">
                                    </div>
                                    <div class="wip-item" data-src="/components/media/gallery/8.jpg"
                                        style="background-image: url(/components/media/gallery/8.jpg);">
                                        <img src="/components/media/gallery/thumbs/8.jpg" alt="">
                                    </div>
                                    <div class="wip-item" data-src="/components/media/gallery/9.jpg"
                                        style="background-image: url(/components/media/gallery/9.jpg);">
                                        <img src="/components/media/gallery/thumbs/9.jpg" alt="">
                                    </div>
                                </div>
                                ...
                                <ul class="wall-attrs clearfix list-inline list-unstyled">
                                    ...
                                    <li class="wa-users">
                                        <a href=""><img src="/components/img/profile-pics/1.jpg" alt=""></a>
                                        <a href=""><img src="/components/img/profile-pics/7.jpg" alt=""></a>
                                        <a href=""><img src="/components/img/profile-pics/9.jpg" alt=""></a>
                                        <a href=""><img src="/components/img/profile-pics/8.jpg" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div class="wall-comment-list">
                                ...
                                <div class="wcl-list">
                                    <div class="media">
                                        <a href="" class="pull-left">
                                            <img src="/components/img/profile-pics/9.jpg" alt="" class="lv-img-sm">
                                        </a>

                                        <div class="media-body">
                                            <a href="" class="a-title">Finn Walking</a> <small class="c-gray m-l-10">3rd
                                                July 2015</small>
                                    ...
                                    <div class="media">
                                        <a href="" class="pull-left">
                                            <img src="/components/img/profile-pics/8.jpg" alt="" class="lv-img-sm">
                                        </a>

                                        <div class="media-body">
                                            <a href="" class="a-title">Benn Holder</a> <small class="c-gray m-l-10">3rd
                                                July 2015</small>
                                            <p class="m-t-5 m-b-0">Class aptent taciti sociosqu ad litora torquent per
                                                conubia nostra...</p>
                                        </div>
                                    ...
                                    <div class="media">
                                        <a href="" class="pull-left">
                                            <img src="/components/img/profile-pics/3.jpg" alt="" class="lv-img-sm">
                                        </a>

                                        <div class="media-body">
                                            <a href="" class="a-title">Seam Ford</a> <small class="c-gray m-l-10">3rd
                                                July 2015</small>
                                            <p class="m-t-5 m-b-0">Praesent bibendum vulputate nulla vitae euismod.
                                                Fusce a metus eu ante sagittis viverra sit amet sed odio.</p>
                                        </div>
