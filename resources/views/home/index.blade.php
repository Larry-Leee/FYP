    ...
    <section id="main" data-layout="layout-1">
        <aside id="sidebar" class="sidebar c-overflow">
            ...
            <ul class="main-menu">
                ...
                <li>
                    <a href="https://wrapbootstrap.com/theme/material-admin-responsive-angularjs-WB011H985"><i
                            class="zmdi zmdi-money"></i> Buy this template</a>
                </li>
            </ul>
        </aside>
        ...
        <aside id="chat" class="sidebar c-overflow">
            ...
            <div class="listview">
                ...
                <a class="lv-item" href="">
                    <div class="media">
                        <div class="pull-left">
                            <img class="lv-img-sm" src="/components/img/profile-pics/5.jpg" alt="">
                        </div>
                        <div class="media-body">
                            <div class="lv-title">Bill Phillips</div>
                ...
                <a class="lv-item" href="">
                    <div class="media">
                        <div class="pull-left">
                            <img class="lv-img-sm" src="/components/img/profile-pics/6.jpg" alt="">
                        </div>
                        <div class="media-body">
                ...
                <a class="lv-item" href="">
                    <div class="media">
                        <div class="pull-left p-relative">
                            <img class="lv-img-sm" src="/components/img/profile-pics/7.jpg" alt="">
                            <i class="chat-status-busy"></i>
                        </div>
                        <div class="media-body">
